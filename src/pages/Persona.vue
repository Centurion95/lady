          ...
          <card class="card">
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="col-md-12 pr-md-1">
                  <label class="control-label"> Fecha de Nacimineto </label>
                  <input
                    type="date"
...
export default {
  ...
  data() {
    BaseInput;
    return {
      url: config.api_url + "/traer_personas/",
      url_insert: config.api_url + "/crear_persona/",
      url_update: config.api_url + "/editar_persona/",
      url_delete: config.api_url + "/eliminar_persona/",
      resultado: null,
