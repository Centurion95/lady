      ...
      <div class="col-6">
        <card>
          <h4 slot="header" class="card-title">
            Registros existentes - {{ this.$route.params.nombre_tabla }}
          </h4>
...
export default {
  ...
  data() {
    BaseInput;
    return {
      url: config.api_url + "/traer_tablas/",
      resultado: null,
  ...
  created() {
    // alert(this.$route.params.nombre_tabla);
    var mi_nombre_tabla = this.$route.params.nombre_tabla;
    axios
      .get(this.url, {
        params: {
          nombre_tabla: mi_nombre_tabla,
        },
      })
      .then((response) => {
